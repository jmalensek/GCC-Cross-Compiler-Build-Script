...
<span style="font-family:Times New Roman">export PATH="build-directory/bin:$PATH"</span>\
NOTE: Replace build-directory whith the directory where your cross compiler will be located ($PREFIX) 
